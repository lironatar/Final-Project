...
class ResourceDecorator {
  ...
  decorateProperties() {
    const resourceProperties = this._resource.properties(); // decorate all exising properties
  ...
  resourceActions(currentAdmin) {
    return Object.values(this.actions).filter(action => action.isResourceType() && action.isVisible(currentAdmin, null) && action.isAccessible(currentAdmin, null));
  }
  /**
